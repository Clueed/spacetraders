...
export type FactionTraitSymbolEnum =
  (typeof FactionTraitSymbolEnum)[keyof typeof FactionTraitSymbolEnum];
...
export type MarketTradeGoodSupplyEnum =
  (typeof MarketTradeGoodSupplyEnum)[keyof typeof MarketTradeGoodSupplyEnum];
...
export type RegisterRequestFactionEnum =
  (typeof RegisterRequestFactionEnum)[keyof typeof RegisterRequestFactionEnum];
...
export type WaypointTraitSymbolEnum =
  (typeof WaypointTraitSymbolEnum)[keyof typeof WaypointTraitSymbolEnum];
...
export const AgentsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getMyAgent(
        options
      );
  ...
  return {
    ...
    async shipRefine(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ShipRefine200Response>
    > {
